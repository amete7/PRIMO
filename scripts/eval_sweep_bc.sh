...
# exp_name="bc_final"
# stage=2
# variant_name="block_10_dim_256_amp"
# checkpoints="
...
#             seed=$seed \
#             checkpoint_path=/storage/home/hcoda1/0/amete7/p-agarg35-0/PRIMO/experiments/metaworld/ML45_PRISE/bc_transformer_policy/${exp_name}/${variant_name}/${seed}/stage_2/${checkpoint}
#     done
# done
