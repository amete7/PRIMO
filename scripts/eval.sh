...
sbatch slurm/run_rtx6000.sbatch python evaluate.py --config-name=evaluate.yaml \
    ...
    algo.beta=0.5 \
    seed=0 \
    checkpoint_path=/storage/home/hcoda1/1/awilcox31/p-agarg35-0/albert/quest/experiments/metaworld/ML45_PRISE/vqbet/bet_final_2/block_5_beta_0.5/0/stage_1
...
sbatch slurm/run_rtx6000.sbatch python evaluate.py --config-name=evaluate.yaml \
    ...
    algo.beta=0.5 \
    seed=1 \
    checkpoint_path=/storage/home/hcoda1/1/awilcox31/p-agarg35-0/albert/quest/experiments/metaworld/ML45_PRISE/vqbet/bet_final_2/block_5_beta_0.5/1/stage_1
...
sbatch slurm/run_rtx6000.sbatch python evaluate.py --config-name=evaluate.yaml \
    ...
    algo.beta=0.5 \
    seed=2 \
    checkpoint_path=/storage/home/hcoda1/1/awilcox31/p-agarg35-0/albert/quest/experiments/metaworld/ML45_PRISE/vqbet/bet_final_2/block_5_beta_0.5/2/stage_1
...
sbatch slurm/run_rtx6000.sbatch python evaluate.py --config-name=evaluate.yaml \
    ...
    algo.beta=0.1 \
    seed=0 \
    checkpoint_path=/storage/home/hcoda1/1/awilcox31/p-agarg35-0/albert/quest/experiments/metaworld/ML45_PRISE/vqbet/bet_final_2/block_5_beta_0.1/0/stage_1
...
sbatch slurm/run_rtx6000.sbatch python evaluate.py --config-name=evaluate.yaml \
    ...
    algo.beta=0.1 \
    seed=1 \
    checkpoint_path=/storage/home/hcoda1/1/awilcox31/p-agarg35-0/albert/quest/experiments/metaworld/ML45_PRISE/vqbet/bet_final_2/block_5_beta_0.1/1/stage_1
...
sbatch slurm/run_rtx6000.sbatch python evaluate.py --config-name=evaluate.yaml \
    ...
    algo.beta=0.1 \
    seed=2 \
    checkpoint_path=/storage/home/hcoda1/1/awilcox31/p-agarg35-0/albert/quest/experiments/metaworld/ML45_PRISE/vqbet/bet_final_2/block_5_beta_0.1/2/stage_1
