...
from diffusion_policy_3d.perception.XMem.model.network import XMem
from diffusion_policy_3d.perception.XMem.inference.data.mask_mapper import MaskMapper
from diffusion_policy_3d.perception.XMem.inference.inference_core import InferenceCore
from diffusion_policy_3d.perception.XMem.dataset.range_transform import im_normalization
from diffusion_policy_3d.perception.utils.grounded_sam import grounded_instance_sam_new_ver
from diffusion_policy_3d.perception.utils.draw_utils import draw_keypoints, aggr_point_cloud_from_data
from diffusion_policy_3d.perception.utils.my_utils import  depth2fgpcd, fps_np
...
class Fusion():
    def __init__(self, num_cam, feat_backbone='dinov2', device='cuda:0', dtype=torch.float32):
        ...
        if self.feat_backbone == 'dinov2':
            self.dinov2_feat_extractor = torch.hub.load('facebookresearch/dinov2', 'dinov2_vits14').to(self.device)
        else:
            raise NotImplementedError
